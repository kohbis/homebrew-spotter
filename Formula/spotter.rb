...
class Spotter < Formula
  ...
  on_macos do
    ...
    sha256 "e413d160cb46c3da4f6e1158c58fbb93b57780d9a2d8f925416a9f384da826c9" # macos
  end

  on_linux do
    url "https://github.com/kohbis/spotter/releases/download/#{version}/spotter-linux.tar.gz"
    sha256 "8727b3fa0d4404ae336f09895e3df016e2b485a5f40d2c43ea9dbced1928e59a" # linux
  end
